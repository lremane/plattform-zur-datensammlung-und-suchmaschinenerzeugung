...
class ModifierPattern(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ModifierPattern - a model defined in OpenAPI
