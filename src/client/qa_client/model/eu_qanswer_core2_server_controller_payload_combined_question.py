...
class EuQanswerCore2ServerControllerPayloadCombinedQuestion(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """EuQanswerCore2ServerControllerPayloadCombinedQuestion - a model defined in OpenAPI
