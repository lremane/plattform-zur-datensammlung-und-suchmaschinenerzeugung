...
class TimeControllerApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.time_using_get_endpoint = _Endpoint(
            settings={
                'response_type': ([Time],),
                'auth': [
                    'JWT'
                ],
                'endpoint_path': '/api/time/annotate',
                'operation_id': 'time_using_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def time_using_get(
        ...
        **kwargs
        ...
        >>> thread = api.time_using_get(async_req=True)
        >>> result = thread.get()
        ...
        return self.time_using_get_endpoint.call_with_http_info(**kwargs)
