...
from qa_client import rest
from qa_client.configuration import Configuration
from qa_client.exceptions import ApiTypeError, ApiValueError, ApiException
from qa_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AnswerControllerApi()
        api_instance.answer_context_using_get  # this is an instance of the class Endpoint
        api_instance.answer_context_using_get()  # this invokes api_instance.answer_context_using_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.answer_context_using_get.callable or self.callable in this class
