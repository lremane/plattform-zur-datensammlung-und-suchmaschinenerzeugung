...
Apache Any23 2.7 (2022-02-21 18:31:44+0000)
  ...
  The most up-to-date documentation can be found at https://any23.apache.org.

  Release Notes
  -------------

  The full list of changes can be found at https://any23.apache.org/changes-report.html.

  System Requirements
  -------------------

  JDK:
    11 or above. (see http://www.oracle.com/technetwork/java/)
  Memory:
...
** Windows 2000/XP
  ...
  1) Unzip the distribution archive, i.e. apache-any23-2.7-bin.zip to the directory you wish to
        install Apache Any23 2.7.
        These instructions assume you chose C:\Program Files\Apache Software Foundation.
        The subdirectory apache-any23-2.7 will be created from the archive.
  ...
  2) Add the ANY23_HOME environment variable by opening up the system properties (WinKey + Pause),
        ...
        C:\Program Files\Apache Software Foundation\apache-any23-2.7.
...
** Unix-based Operating Systems (Linux, Solaris and Mac OS X)
  ...
  1) Extract the distribution archive, i.e. apache-any23-2.7-bin.tar.gz to the directory you wish to
        install Apache Any23 2.7.
  ...
  2) In a command terminal, add the ANY23_HOME environment variable, e.g.
        export ANY23_HOME=/usr/local/apache-any23/apache-any23-2.7.
  ...
  Home Page:          https://any23.apache.org/
  Downloads:          https://any23.apache.org/download.html
  Release Notes:      https://any23.apache.org/changes-report.html
  Mailing Lists:      https://any23.apache.org/mail-lists.html
  Source Code:        https://github.com/apache/any23/tree/any23-2.7
  Issue Tracking:     https://issues.apache.org/jira/browse/ANY23
  Available Plugins:  https://any23.apache.org/plugins.html
